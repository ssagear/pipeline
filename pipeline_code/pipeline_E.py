...
with open(r'/Users/sheilasagear/OneDrive/K2_Research/CorrectedLC_EPICID/Cycle2_4_CSV/hlsp_k2sff_k2_lightcurve_229227268-c06_kepler_v1_llc-default-aper.csv') as f:
    reader = csv.reader(f)
...
###########################
    ...
    ax.scatter(phases, merged_flux, s=2, c='k')
...
#start values are correct values
    ...
    if True: #SDE >= 6:
        ...
        trend, ferr = untrendy.untrend(time, merged_flux)
