...
##########################
        ...
        results = bls.eebls(time, merged_flux, u, v, 1000.0, .3, .001, 500.0, .01, .1)
...
numpy.savetxt('/Users/sheilasagear/OneDrive/K2_Research/bls-ktransit/SDE_text/data229227248.txt', numpy.column_stack((detect_diff, detect_SDE, detect_BLS_per, detect_per, detect_rad)), fmt='%.5f')
