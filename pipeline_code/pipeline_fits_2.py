...
path_to_list = '/Users/sheilasagear/Dropbox/K2/K2_targets/C7-search.txt'
...
for f in range(filecount):
    ...
    plt.savefig('/Users/sheilasagear/Dropbox/ssagear_k2/plots/C7_planet_search/' + str(targetname) + '_bls.png')
    ...
    plt.savefig('/Users/sheilasagear/Dropbox/ssagear_k2/plots/C7_planet_search/' + str(targetname) + '_phase_fold.png')
