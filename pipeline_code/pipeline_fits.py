...
def data_K2(fitspath):
    ...
    if os.path.isfile(fitspath):
        ...
        #SIGMA CLIPPING
        flux = sigma_clip(flux, sigma=5, iters=1)
...
path_to_list = '/Users/sheilasagear/Dropbox/K2/K2_targets/C16_17_targets_cont.txt'
...
for f in range(filecount):
    ...
    plt.savefig('/Users/sheilasagear/Dropbox/ssagear_k2/plots/C16_17_planet_search/' + str(targetname) + '_bls.png')
    ...
    plt.savefig('/Users/sheilasagear/Dropbox/ssagear_k2/plots/C16_17_planet_search/' + str(targetname) + '_phase_fold.png')
